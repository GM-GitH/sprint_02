        ...
        <div className="container">
          <div className="filters">
            <div className="left-filter">
              <button className="left-filter__button">All Rooms</button>
            ...
            <div className="right-filter">
              ...
              <button className="right-filter__button">Newest <span className="right-filter__button__arrow">v</span></button>
            </div>
          </div>
          <RoomsTable/>
        </div>
